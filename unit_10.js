...
// let ar6 =
let ar6 = ['Alexandr', 'Vodoley', 10, 02];
function f6() {
    let out = '';
...
function f16() {
    for (i = 0; i < ar16.length; i++) {
        if (ar16[i] % 2 == 0) {
            ar16_even.unshift(ar16[i]);
        }
        else {
            ar16_odd.unshift(ar16[i]);
        }
    }
